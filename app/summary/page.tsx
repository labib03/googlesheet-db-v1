    ...
    <div className="min-h-screen bg-slate-50/50 dark:bg-slate-950/50 font-sans selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <SummaryLayout>
          ...
          {error && (
            <SummarySection>
              <Card className="mx-auto max-w-2xl border-none shadow-sm bg-white dark:bg-slate-900 rounded-2xl ring-1 ring-red-100 dark:ring-red-900/30 overflow-hidden">
