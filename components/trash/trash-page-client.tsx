      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 px-1">
        <div className="flex flex-col space-y-2">
          <div className="flex items-center gap-3">
            ...
            <div className="p-2 bg-rose-500 rounded-xl text-white shadow-lg shadow-rose-200 dark:shadow-none">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 max-w-xl pl-0 md:pl-12">
